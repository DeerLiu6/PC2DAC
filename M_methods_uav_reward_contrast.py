...
file_path1 = 'logs/uav_reward/U_reward_pc2dac.json'
file_path2 = 'logs/uav_reward/U_reward_2dac.json'
file_path3 = 'logs/uav_reward/U_reward_pcac.json'
file_path4 = 'logs/uav_reward/U_reward_ac.json'
...
plt.title('UAV Rewards Contrast')
plt.legend(['PC2DAC', '2DAC', 'PCAC', 'AC'],loc='upper left')
