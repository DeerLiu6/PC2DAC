...
file_path1 = 'logs/peak_age/peak_age_pc2dac.json'
file_path2 = 'logs/peak_age/peak_age_2dac.json'
file_path3 = 'logs/peak_age/peak_age_pcac.json'
file_path4 = 'logs/peak_age/peak_age_ac.json'
