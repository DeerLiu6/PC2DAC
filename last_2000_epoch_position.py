...
uav_positoin_x0 = 'logs/position/uav_x0_last.npy'
uav_positoin_y0 = 'logs/position/uav_y0_last.npy'
uav_positoin_x1 = 'logs/position/uav_x1_last.npy'
uav_positoin_y1 = 'logs/position/uav_y1_last.npy'
uav_positoin_x2 = 'logs/position/uav_x2_last.npy'
uav_positoin_y2 = 'logs/position/uav_y2_last.npy'
uav_positoin_x3 = 'logs/position/uav_x3_last.npy'
uav_positoin_y3 = 'logs/position/uav_y3_last.npy'
...
ax.text(0.5, 0.92, 'uav-1', transform=ax.transAxes, fontsize=12,
        verticalalignment='top', bbox=bbox_props, color='blue', alpha=0.5)
ax.text(0.5, 0.05, 'uav-2', transform=ax.transAxes, fontsize=12,
        verticalalignment='top', bbox=bbox_props, color='blue', alpha=0.5)
ax.text(0.02, 0.45, 'uav-3', transform=ax.transAxes, fontsize=12,
        verticalalignment='top', bbox=bbox_props, color='blue', alpha=0.5)
ax.text(0.90, 0.45, 'uav-4', transform=ax.transAxes, fontsize=12,
        verticalalignment='top', bbox=bbox_props, color='blue', alpha=0.5)
